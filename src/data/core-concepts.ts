// Core ICT Concepts — D·E·E·D model answers for the IFP105 syllabus.
//
// Each entry is one concept the student must understand to write a
// confident long answer in any ICT exam. Same D·E·E·D shape (Define,
// Explain, Example, Diagram) used in /exam-prep so the framing is
// consistent — students learn ONE answer pattern and reuse it.
//
// Framing rule (carved into every heading and label across the UI):
//   ✅ "These are the core ICT concepts in your syllabus."
//   ❌ Never "this will come in the exam" / "expected questions".
//
...
export interface ConceptCard {
  ...
  // ── Examiner-facing extras ─────────────────────────────────────
  /** 3–4 phrases the examiner expects to see in a good answer. */
  keyPhrases: string[];
  /** Specific things that earn marks for THIS concept. */
  earnsMarks: string[];
  /** Specific things that lose marks for THIS concept. */
  losesMarks: string[];
  /** One-sentence pep talk / strategic tip. */
  tip: string;
}
...
> = {
  "computer-basics": {
    ...
    icon: "💻",
    accent: "#818CF8",
    description: "The fundamentals every ICT student must own.",
  },
  office: {
    label: "MS Office",
    icon: "📄",
...
export const CORE_CONCEPTS: ConceptCard[] = [
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    losesMarks: [
      "Listing only screens and keyboards (lazy — too narrow)",
      "Calling Windows or MS Word hardware (that's software!)",
      "Skipping the diagram on a 6-mark question",
    ],
    tip: "Think of the four blocks: <strong>input → process → output</strong>, with storage underneath. If you draw that, you've already earned the diagram marks.",
  },
  {
    id: "software",
    group: "computer-basics",
  ...
  },
  {
    ...
    tip: "Use the <strong>fast/small/temporary</strong> vs <strong>slow/big/permanent</strong> rhythm — three contrasts in one breath. Examiners love clean parallel structure.",
  },
  {
  ...
  },
  {
    ...
    tip: "Always say \"<em>select first, then click</em>\". That one phrase shows the examiner you actually know how to use Word, not just memorise buttons.",
  },
  {
    ...
    tip: "Always include \"<em>saves time on a long document</em>\" — that's the WHY, and examiners reward you for explaining the value, not just the steps.",
  },
  {
    ...
    tip: "Memorise this rule: <strong>Save = same file. Save As = new file.</strong> One sentence, examiners love it.",
  },
  {
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    tip: "Always present social media <strong>balanced</strong> — two benefits, two risks. Examiners reward maturity, not preaching.",
  },
  {
  ...
  },
  {
    ...
    tip: "Action first, theory second. Tell the examiner what you'll do tomorrow morning: \"<em>Add my photo and write a one-line headline</em>\". Concrete plan = full marks.",
  },
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    tip: "Memorise this one example: <code>&lt;a href=\"google.com\"&gt;Search&lt;/a&gt;</code>. Point at the parts in order — examiner sees you actually understand it.",
  },
  {
    id: "html-comments",
    group: "html",
    ...
    tip: "If you can write the syntax <code>&lt;!-- … --&gt;</code> and one example, you have the whole 4-mark answer.",
  },
  {
    id: "html-tables",
    group: "html",
  ...
  },
  {
    ...
    tip: "Memorise: \"<strong>Ordered = numbered. Unordered = bulleted.</strong>\" If you can write <code>&lt;ol&gt;&lt;li&gt;…&lt;/li&gt;&lt;/ol&gt;</code> from memory, you've got the marks.",
  },
  {
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    tip: "Always ground AI in <strong>two apps the student uses every day</strong>. Concrete > abstract every time.",
  },
  {
    id: "machine-learning",
    group: "emerging",
  ...
  },
  {
    ...
    tip: "The Venn diagram is the killer move here. Two seconds to draw, and it answers the entire question visually.",
  },
  {
    id: "blockchain",
    group: "emerging",
    ...
    tip: "The chain-with-hashes diagram is gold. Three blocks, three hashes, two arrows — students who draw this almost always get full marks.",
  },
  {
    id: "ar-vs-vr",
    group: "emerging",
  ...
  },
  {
    ...
    tip: "End with one rule the examiner will quote back: \"<em>I use AI to understand a topic, then write my answer in my own words.</em>\" That sentence wins the question.",
  },
];
