  ...
  // ─── Topic 1 ───
  {
    ...
    content: [
      ...
      },
      {
        ...
        type: "text",
        html: `<div style="background:linear-gradient(135deg,rgba(99,102,241,0.06),rgba(59,130,246,0.06));border:1px solid rgba(99,102,241,0.18);border-radius:14px;padding:24px 20px;margin:8px 0;overflow-x:auto"><svg viewBox="0 0 720 360" style="width:100%;height:auto;min-width:560px;display:block" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="A user at the centre with two-way arrows to Instagram, TikTok, Telegram, YouTube, Facebook, and X — showing how social media is a conversation, not a broadcast"><defs><radialGradient id="t1glow" cx="50%" cy="50%" r="50%"><stop offset="0" stop-color="rgba(99,102,241,0.35)"/><stop offset="1" stop-color="rgba(99,102,241,0)"/></radialGradient><marker id="t1arrowR" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="5" markerHeight="5" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#818CF8"/></marker></defs><text x="360" y="22" text-anchor="middle" fill="#71717A" font-size="11" font-family="system-ui" font-weight="700" letter-spacing="3">SOCIAL MEDIA · TWO-WAY</text><circle cx="360" cy="190" r="80" fill="url(#t1glow)"/><g transform="translate(360,75)"><circle r="28" fill="rgba(56,189,248,0.12)" stroke="#38BDF8" stroke-width="1.8"/><text y="5" text-anchor="middle" font-size="22">✈️</text><text y="48" text-anchor="middle" fill="#7DD3FC" font-size="10" font-family="system-ui" font-weight="700">TELEGRAM</text></g><g transform="translate(110,115)"><circle r="28" fill="rgba(236,72,153,0.12)" stroke="#EC4899" stroke-width="1.8"/><text y="5" text-anchor="middle" font-size="22">📷</text><text y="48" text-anchor="middle" fill="#F472B6" font-size="10" font-family="system-ui" font-weight="700">INSTAGRAM</text></g><g transform="translate(610,115)"><circle r="28" fill="rgba(239,68,68,0.12)" stroke="#EF4444" stroke-width="1.8"/><text y="5" text-anchor="middle" font-size="22">▶️</text><text y="48" text-anchor="middle" fill="#FCA5A5" font-size="10" font-family="system-ui" font-weight="700">YOUTUBE</text></g><g transform="translate(360,190)"><circle r="38" fill="rgba(99,102,241,0.15)" stroke="#818CF8" stroke-width="2"/><text y="6" text-anchor="middle" font-size="34">🧑</text><text y="56" text-anchor="middle" fill="#A5B4FC" font-size="11" font-family="system-ui" font-weight="700" letter-spacing="2">YOU</text></g><g transform="translate(110,265)"><circle r="28" fill="rgba(20,184,166,0.12)" stroke="#14B8A6" stroke-width="1.8"/><text y="5" text-anchor="middle" font-size="22">🎵</text><text y="48" text-anchor="middle" fill="#5EEAD4" font-size="10" font-family="system-ui" font-weight="700">TIKTOK</text></g><g transform="translate(610,265)"><circle r="28" fill="rgba(37,99,235,0.12)" stroke="#2563EB" stroke-width="1.8"/><text y="5" text-anchor="middle" font-size="22">f</text><text y="48" text-anchor="middle" fill="#93C5FD" font-size="10" font-family="system-ui" font-weight="700">FACEBOOK</text></g><g transform="translate(360,310)"><circle r="28" fill="rgba(161,161,170,0.12)" stroke="#A1A1AA" stroke-width="1.8"/><text y="5" text-anchor="middle" font-size="22">𝕏</text><text y="48" text-anchor="middle" fill="#D4D4D8" font-size="10" font-family="system-ui" font-weight="700">X</text></g><g fill="none" stroke-width="1.4" opacity="0.55"><path d="M 138 110 Q 240 140 322 170" stroke="#EC4899" stroke-dasharray="4 3" marker-end="url(#t1arrowR)"/><path d="M 322 210 Q 240 240 138 248" stroke="#EC4899" stroke-dasharray="4 3" marker-end="url(#t1arrowR)"/><path d="M 138 252 Q 240 230 322 208" stroke="#14B8A6" stroke-dasharray="4 3" marker-end="url(#t1arrowR)"/><path d="M 322 172 Q 240 200 138 240" stroke="#14B8A6" stroke-dasharray="4 3" marker-end="url(#t1arrowR)"/><path d="M 360 105 L 360 150" stroke="#38BDF8" stroke-dasharray="4 3" marker-end="url(#t1arrowR)"/><path d="M 354 150 L 354 105" stroke="#38BDF8" stroke-dasharray="4 3" marker-end="url(#t1arrowR)"/><path d="M 582 110 Q 480 140 398 170" stroke="#EF4444" stroke-dasharray="4 3" marker-end="url(#t1arrowR)"/><path d="M 398 210 Q 480 240 582 252" stroke="#2563EB" stroke-dasharray="4 3" marker-end="url(#t1arrowR)"/><path d="M 360 280 L 360 232" stroke="#A1A1AA" stroke-dasharray="4 3" marker-end="url(#t1arrowR)"/></g></svg></div>`,
      },
      {
        type: "analogy",
