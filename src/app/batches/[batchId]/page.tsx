        ...
        <div className="relative p-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              className="flex items-center justify-center gap-1.5 px-4 py-2 rounded-xl text-[11px] font-medium bg-[#0A66C2]/10 text-[#0A66C2] border border-[#0A66C2]/20 hover:bg-[#0A66C2]/20 hover:border-[#0A66C2]/40 transition-all"
            >
