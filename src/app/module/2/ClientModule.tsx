...
const excelChallenges: Record<number, any[]> = {
  ...
  5: [
    ...
    { title: "Count the students", description: "How many scores are there? Use COUNT.", hint: "Use =COUNT(A1:A5)", initialData: { A1: "72", A2: "88", A3: "95", A4: "61", A5: "83" }, targetCell: "B1", expectedFormula: ["=COUNT(A1:A5)", "=count(a1:a5)"], expectedResult: "5" },
    { title: "Multiply two numbers", description: "A1 has the price (50) and B1 has the quantity (3). Calculate the total in C1.", hint: "Use =A1*B1", initialData: { A1: "50", B1: "3" }, targetCell: "C1", expectedFormula: ["=A1*B1", "=a1*b1"], expectedResult: "150" },
  ],
  6: [
  ...
  return (
    <ModulePage
      ...
      renderAfterContent={(topicId) => (
        <>
          {(topicId === 2 || topicId === 3) && (
            <ShortcutTrainer shortcuts={wordShortcuts} title="Practice Word Shortcuts" />
          )}
