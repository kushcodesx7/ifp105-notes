...
import { mcqData as _mcqData4 } from "@/data/module4-mcq";
...
const _mcqCount4 = Object.values(_mcqData4).reduce((sum, arr) => sum + (arr?.length ?? 0), 0);
...
const editorDefaults: Record<number, string> = {
  ...
  10: '<!-- Topic 10: Images -->\n<!DOCTYPE html>\n<html>\n<body>\n  <h2>Image Practice</h2>\n  <img src="https://placehold.co/300x200/4F46E5/ffffff?text=IFP105" alt="Course image" width="300">\n  <br><br>\n  <a href="https://www.google.com">\n    <img src="https://placehold.co/150x50/10B981/ffffff?text=Click+Me" alt="Clickable image">\n  </a>\n  <figure>\n    <img src="https://placehold.co/250x150/8B5CF6/ffffff?text=Figure" alt="Figure">\n    <figcaption>This is a figure caption</figcaption>\n  </figure>\n</body>\n</html>',
  ...
  return (
    <ModulePage
      ...
      stats={[
        { n: "11", l: "Topics" },
        { n: "~55", l: "Minutes" },
        { n: String(_mcqCount4), l: "Practice Qs" },
      ]}
      renderAfterContent={(topicId) => (
        <div className="mt-6">
          ...
          <HtmlEditor initialCode={editorDefaults[topicId] || editorDefaults[1]} />
          {module4Challenges[topicId] && (
            <YourTurnChallenge challenge={module4Challenges[topicId]} accentFrom="#06B6D4" accentTo="#0891B2" />
          )}
          {module4BugFixes[topicId] && (
            <BugFixChallenge challenge={module4BugFixes[topicId]!} accentFrom="#06B6D4" accentTo="#0891B2" />
          )}
